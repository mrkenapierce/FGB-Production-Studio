...
# The YouTube destination rebuilds A/V clocks from decoded frame/sample counts.
# The master and Rumble paths remain untouched. Lovable control is isolated in
# the overlay worker and can never block this FFmpeg media clock.
exec ffmpeg \
