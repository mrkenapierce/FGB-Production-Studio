...
# hot-reloaded from the RSS poller's text file. This avoids the extra live HTTP
# video input that can pull A/V pacing behind real time. Orange masks are drawn
# after the headline so text enters/exits beneath the orange boundaries.
ffmpeg \
