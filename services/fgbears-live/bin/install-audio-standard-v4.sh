...
install -m 0755 "$ROOT/bin/lovable-audio-pipeline-v4-runner.py" /usr/local/bin/fgbears-lovable-audio-pipeline
...
echo 'FGB audio standard v4.1 installed: master-owned 44.1 kHz AAC clock, zero loudness/dynamics processing, Lovable approval sync ready.'
